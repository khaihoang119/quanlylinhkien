...
--
-- Host: localhost
-- Generation Time: Nov 27, 2023 at 04:35 AM
...
INSERT INTO `products` (`productID`, `productName`, `image`, `productPrice`, `shortDes`, `longDes`, `categoryID`, `status`) VALUES
(3, 'Bàn Phím CMK75', 'banphim01', 2000000, 'Bàn Phím CMK', 'Bàn Phím CMK 75 của hãng FLC', 1, 1),
(4, 'Màn Hình Cong MSI Optix MAG321CQR 144Hz', 'manhinh01', 10000000, 'Màn hình cong', 'Màn hình cong của hãng msi', 2, 1);
