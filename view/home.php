                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="card p-3" style="width: 18rem;">
                                            <img src="./assets/client/img/products/laptop01.webp" class="card-img-top"
                                                 alt="...">
                                            <div class="row">
                                                <div class="card-body ">
                                                    <p class="card-text fw-bold">Laptop gaming Acer Predator Helios 300
                                                        PH315 55
                                                        76KG</p>
                                                    <div class="text-start p-3">
                                                        <p class="card-text text-decoration-line-through fw-light">
                                                            90.000.000 đ</p>
